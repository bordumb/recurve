...
oracle_verdict(test, 'def task_func(a,b):\n return a+b\n', runs=1, timeout=30)
...
from evallib.quarantine import oracle_verdict
test='import unittest\nclass T(unittest.TestCase):\n def test(self): self.assertEqual(task_func(1,2),3)\n'
assert oracle_verdict(test, 'def task_func(a,b):\n return a+b\n', runs=1)['verdict']=='pass'
