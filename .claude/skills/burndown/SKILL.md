---
name: burndown
description: Launch the unattended claims burndown for recurve — sequential fresh agents close RED gaps under the fleet gate until done, capped, or parked out
---
